...
\TLV
   ...
   |cpu
      @0
         $reset = *reset;
         //$valid = !$reset ? 32'b0 : >>3$valid+1;
         
         
         //$pc[31:0] = >>1$reset ? 32'b0 : >>1$pc +4;
         $pc[31:0] = $reset ? 32'b0 : >>3$valid_taken_br 
                            ? >>3$br_tgt_pc : >>3$valid_jump && >>3$is_jal 
                            ? >>3$br_tgt_pc : $valid_jump && >>3$is_jalr 
                            ? >>3$jal_tgt_pc : >>3$inc_pc;
      ...
      @1
         ...
         //$rf_rd_en2 = $reset ? 32'b0 : $rf_rd_index2[4:0];
      @2 
      ...
      @3 
         $result[31:0] = $is_addi ? $src1_value + $imm : $is_add
                                     ? $src1_value + $src2_value : $is_sub
                                       ...
                                       ? $src1_value | $imm :  $is_xori
                                        ...
                                        ? $pc + 4 : $is_jalr
                                        ? $pc + 4 : $srai
                                        ? { {32{$src1_value[31]}}, $src1_value} >> $imm[4:0] : $slt
                                        ? ($src1_value[31] == $src2_value[31]) : $sltu_rslt ? {31'b0, $src1_value[31]} : $slti
                                        ? ($src1_value[31] == $imm[31]) : $sltiu_rslt ? {31'b0, $src1_value[31]} : $sra
                                        ? { {32{$src1_value[31]}}, $src1_value} >> $src2_value[4:0] : 32'b0;
         ...
         $valid = !$reset ? 32'b0 : >>3$valid+1;
         $rf_wr_data = >>2$valid_load ? >>2$ld_data : 32'b0; 
         //$valid_jump = &valid && $imm;
         
         
      @4 $rf_wr_en = $rd_valid ? $rd[$rf_wr_index[4:0]]: $rf_wr_data[31:0];
         //$rf_wr_data = >>2$valid_load ? >>2$ld_data : 32'b0; 
